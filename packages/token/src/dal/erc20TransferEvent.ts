...
import { ERC20TransferEvent, TokenAccount } from '../types.js'
import { uint256ToBigNumber, uint256ToNumber } from '../utils/index.js'
...
export function createERC20TransferEventDAL(
  path: string,
  tokenConfig: Record<string, TokenAccount>,
    ...
    mapValueFn: async (value: any) => {
      ...
      try {
        ...
        value.valueNum = uint256ToNumber(
          value.value,
          tokenConfig[value.blockchain].decimals,
        )
      } catch (e) {
        console.log(e)
